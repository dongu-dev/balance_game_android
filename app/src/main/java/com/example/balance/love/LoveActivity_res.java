...
public class LoveActivity_res extends AppCompatActivity {
    ...
    private String str_voteResult1_res;
    private String str_voteResult2_res;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str_voteResult1_res = pref.getString("str_voteResult1", "0");
        str_voteResult2_res = pref.getString("str_voteResult2", "0");

        res_textView1.setText(str_voteResult1_res + "표");
        res_textView2.setText(str_voteResult2_res + "표");
